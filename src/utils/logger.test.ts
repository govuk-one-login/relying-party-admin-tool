import { getRefererFrom } from "./logger.js";
...
describe("logger", () => {
  describe(getRefererFrom, () => {
    ...
    it("should return undefined for null url", () => {
      expect(getRefererFrom(null)).toBeUndefined();
    });

    it("should return undefined for undefined url", () => {
      expect(getRefererFrom(undefined)).toBeUndefined();
    });

    it("should return undefined for invalid url", () => {
      expect(getRefererFrom("hello")).toBeUndefined();
    });

    it("should return undefined for invalid protocol", () => {
      expect(getRefererFrom("https;//hello")).toBeUndefined();
    });

    it("should return undefined for invalid port", () => {
      expect(getRefererFrom("https://localhost:hello")).toBeUndefined();
    });
  });
});
